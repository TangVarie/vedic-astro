...
=====================================================
Supports ALL Vedic skill outputs: Core, Career, Love, Soul, Timing, Q&A

Usage:
  python report_builder.py <folder> [--name "Name"] [--lagna "Cancer"] [--lang cn]

v3.4 修复: 扫描根目录 + parts/ 子目录, 不再因为 parts/ 存在而忽略根目录主报告.
  - 主报告 (p2a_planets/career_*/love_*/s1_*/timing_*) 优先取根目录
  - parts/ 中的同名文件不覆盖 (除非根目录缺失)
  - Q&A 文件 (qa_*.md) 两边都扫, 合并展示

Supported file patterns (v3 修订对齐实际输出):
  Core:    p2a_planets.md, p2b_planets.md, p2c_planets.md,
           p3_divisional.md, p4_houses.md, p5a_life.md, p5b_life.md,
           appendix.md
  Career:  career_archetypes.md, career_phase12.md, career_phase3.md,
           career_phase4a.md, career_phase4b.md, career_phase4c.md,
           career_change.md
           (legacy: career_part1/2/3.md, career_phase1_2.md, career.md)
  Love:    love_step1.md, love_step2.md, love_step3.md, love_timing.md
           (legacy: love_part1/2.md, love.md)
  Soul:    s1_atmakaraka.md, s2_karakamsa.md, s3_karaka_team.md,
           s4_ishta_devata.md, s5_past_life.md, s6_dharma_path.md
  Timing:  timing_transit_summary.md, timing_dasha_summary.md, timing_yearly_summary.md
           (legacy: timing_gochara/dasha/varshaphala.md)
...
SECTION_REGISTRY = [
    ...
    (57, "appendix",  "Technical Appendix",                    "技术附录",
     ["appendix.md"]),
    # Career (v3 修订：对齐实际输出文件名 career_phase12/3/4a/4b/4c + archetypes/change)
    (58, "career_arch", "Part VI-pre: Career Archetypes",          "第六部分前导：事业原型",
     ["career_archetypes.md"]),
    (60, "career1",   "Part VI: Career — Portrait & Narrative",   "第六部分：事业 — 画像与叙事",
     ["career_phase12.md", "career_phase1_2.md", "career_part1.md"]),
    (65, "career2",   "Part VI (cont.): Career — Strategy",       "第六部分（续）：事业 — 战略决策",
     ["career_phase3.md", "career_part2.md"]),
    (66, "career3a",  "Part VI (cont.): Career — Risk Map",       "第六部分（续）：事业 — 风险地图",
     ["career_phase4a.md"]),
    (67, "career3b",  "Part VI (cont.): Career — Action Strategy", "第六部分（续）：事业 — 行动战略",
     ["career_phase4b.md"]),
    (68, "career3c",  "Part VI (cont.): Career — Advice",         "第六部分（续）：事业 — 箴言建议",
     ["career_phase4c.md", "career_phase4.md", "career_part3.md"]),
    (69, "career_chg","Part VI (extra): Career Change",           "第六部分（附）：事业转型",
     ["career_change.md"]),
    (70, "career",    "Part VI: Career Architecture",             "第六部分：事业架构",
     ["02_career.md", "06_career.md", "career.md"]),
    # Love (v3 修订：对齐实际输出 love_step1/2/3 + love_timing)
    (80, "love1",     "Part VII: Love — Compatibility & System",  "第七部分：感情 — 体质与配偶画像",
     ["love_step1.md", "love_part1.md"]),
    (82, "love2",     "Part VII (cont.): Love — Timeline",        "第七部分（续）：感情 — 时间轴",
     ["love_step2.md", "love_part2.md"]),
    (84, "love3",     "Part VII (cont.): Love — Advice & Risk",   "第七部分（续）：感情 — 建议与风险",
     ["love_step3.md"]),
    (86, "love_t",    "Part VII (cont.): Love — Detailed Timing", "第七部分（续）：感情 — 时机锁定",
     ["love_timing.md"]),
    (90, "love",      "Part VII: Love & Marriage",                "第七部分：感情与婚姻",
     ["03_love.md", "07_love.md", "love.md"]),
    # Soul (v3 新增：之前完全缺失)
    (92, "soul1",     "Part VIII: Soul — Atmakaraka",             "第八部分：灵魂 — 此生主功课 (AK)",
     ["s1_atmakaraka.md"]),
    (93, "soul2",     "Part VIII (cont.): Soul — Karakamsa",      "第八部分（续）：灵魂 — Karakamsa 灵魂地图",
     ["s2_karakamsa.md"]),
    (94, "soul3",     "Part VIII (cont.): Soul — Karaka Team",    "第八部分（续）：灵魂 — Karaka 团队",
     ["s3_karaka_team.md"]),
    (95, "soul4",     "Part VIII (cont.): Soul — Ishta Devata",   "第八部分（续）：灵魂 — 本命神",
     ["s4_ishta_devata.md"]),
    (96, "soul5",     "Part VIII (cont.): Soul — Past Life",      "第八部分（续）：灵魂 — 前世业力线索",
     ["s5_past_life.md"]),
    (97, "soul6",     "Part VIII (cont.): Soul — Dharma Path",    "第八部分（续）：灵魂 — Dharma 路径",
     ["s6_dharma_path.md"]),
    # Timing (v3.2 修订：对齐 vedic-timing 实际输出文件名 timing_*_summary.md)
    (98, "timing_g",  "Part IX: Timing — Gochara (Transit)",      "第九部分：时机 — 行运分析",
     ["timing_transit_summary.md", "timing_gochara.md", "timing_transit.md"]),
    (99, "timing_d",  "Part IX (cont.): Timing — Multi-Dasha",    "第九部分（续）：时机 — 多 Dasha 验证",
     ["timing_dasha_summary.md", "timing_dasha.md", "timing_multi_dasha.md"]),
    (99.5, "timing_y","Part IX (cont.): Timing — Yearly (Varshaphala)", "第九部分（续）：时机 — 年盘",
     ["timing_yearly_summary.md", "timing_varshaphala.md", "timing_yearly.md"]),
    # Q&A
...
def detect_analysis_mode(folder):
    """Detect analysis_mode from structured_data.md in folder or its parent.
    
    Looks for a line like 'analysis_mode: calibrated' or 'analysis_mode: blind'.
    Returns 'blind', 'calibrated', or None (not found / unspecified).
    
    Search order:
      1. folder/structured_data.md
      2. folder/../structured_data.md (one level up, common when folder is per-client)
    """
    candidates = [
        os.path.join(folder, "structured_data.md"),
        os.path.join(folder, "..", "structured_data.md"),
    ]
    for path in candidates:
        ...
        try:
            ...
            continue
        # Match: analysis_mode: <value> (case-insensitive, tolerant of whitespace)
        m = re.search(r"^[ \t>*-]*analysis_mode\s*[:=]\s*(blind|calibrated)\b",
...
def scan_root_and_parts(folder):
    """Scan folder AND folder/parts/ together. v3.4 修复:
    
    旧逻辑: 只要 parts/ 存在就只扫 parts/, 根目录的主报告全被忽略 (bug).
    
    新逻辑: 先扫根目录, 再扫 parts/. 
      - 主报告 (p2a_planets/career_*/love_*/s1_*/timing_*) 优先取根目录.
      - parts/ 里同名的不覆盖根目录 (除非根目录没有).
      - Q&A 文件 (qa_*.md) 两边都收, parts/ 优先, 因为 skill 协议要求 Q&A 存 parts/.
    """
    print(f"  Scanning root: {folder}")
    root_found = find_files(folder)
    
    parts_dir = os.path.join(folder, "parts")
    if not os.path.isdir(parts_dir):
        return root_found
    
    print(f"  Scanning parts: {parts_dir}")
    parts_found = find_files(parts_dir)
    
    # 合并: 根目录优先, 但 qa 用 parts/ 的版本 (如果 parts/ 有 qa)
    merged = dict(root_found)
    for k, v in parts_found.items():
        if k == "qa":
            # Q&A 合并两边: 如果根目录已有 qa, 把 parts/ 的内容追加到末尾
            if "qa" in merged:
                root_qa = merged["qa"][3]
                parts_qa = v[3]
                combined_qa = root_qa + "\n\n---\n\n" + parts_qa
                merged["qa"] = (100, "Appendix: Q&A", "附录：追问答疑", combined_qa)
            else:
                merged["qa"] = v
        elif k not in merged:
            # parts/ 里的主报告只在根目录缺失时使用
            merged[k] = v
...
def detect_package(found, lang="cn"):
    has_core = any(k in found for k in [
        "core", "planets", "planets_a", "planets_b", "planets_c",
        "divisional", "houses", "life", "life2", "appendix"
    ])
    has_career = any(k in found for k in ["career", "career1", "career2", "career3a", "career3b", "career3c", "career_arch", "career_chg"])
    has_love = any(k in found for k in ["love", "love1", "love2", "love3", "love_t"])
    has_soul = any(k in found for k in ["soul1", "soul2", "soul3", "soul4", "soul5", "soul6"])
    has_timing = any(k in found for k in ["timing_g", "timing_d", "timing_y"])
    has_qa = "qa" in found
    ...
    if has_soul:    parts.append("Soul" if lang == "en" else "灵魂")
    if has_timing:  parts.append("Timing" if lang == "en" else "时机")
...
def build_cover(name, lagna, gender, status, pkg, desc, systems, lang="cn"):
...
<div class="cover">
  ...
  <div class="cover-meta"><div class="cover-meta-grid">
    ...
    <div><dt>{L[4]}</dt><dd>{systems}</dd></div>
...
def detect_systems(found, lang="cn"):
    """根据 found 中实际包含的 skill 输出，决定封面"体系"字段。
    
    KN Rao Parashari 是底层，soul/love/timing/varshaphala 会引入 Jaimini/SJC/Tajaka/BSP。
    """
    has_soul = any(k in found for k in ["soul1", "soul2", "soul3", "soul4", "soul5", "soul6"])
    has_love = any(k in found for k in ["love", "love1", "love2", "love3", "love_t"])
    has_timing_y = "timing_y" in found  # Varshaphala 用 Tajaka
    has_timing_d = "timing_d" in found  # 多 Dasha 用 Jaimini Chara Dasha + Yogini
    has_timing_g = "timing_g" in found  # 行运用 BSP/Bhrigu Bindu
    
    modules = []
    if has_soul:
        modules.append("Jaimini" if "Jaimini" not in modules else None)
        modules.append("SJC")
    if has_love:
        if "Jaimini" not in modules:
            modules.append("Jaimini")  # DK/UL 来自 Jaimini
    if has_timing_d:
        if "Jaimini" not in modules:
            modules.append("Jaimini")  # Chara Dasha
        modules.append("Yogini")
    if has_timing_y:
        modules.append("Tajaka")  # Varshaphala
    if has_timing_g:
        modules.append("BSP")  # Bhrigu Bindu / Sade Sati
    
    modules = [m for m in modules if m]  # 清 None
    
    if not modules:
        return ("Parashari Jyotish | KN Rao School" if lang == "en"
                else "Parashari / KN Rao 派")
    
    mod_str = " / ".join(modules)
    if lang == "en":
        return f"Parashari / KN Rao base + {mod_str} modules where used"
    return f"Parashari / KN Rao 为底层 + 显式调用 {mod_str} 模块"
...
Examples:
  ...
  python report_builder.py ./analysis --name "测试" --lagna "天蝎座" --lang cn
    ...
    parser.add_argument("--mode", default="blind", choices=["blind", "calibrated"],
                        help="Analysis mode: blind (pure blind audit) or calibrated "
                             "(used signal correction log). Auto-detected from "
                             "structured_data.md analysis_mode field if present; "
                             "this CLI arg overrides auto-detection. Default: blind.")
    parser.add_argument("--output", default=None, help="Output HTML path")
    parser.add_argument("--include", default=None,
                        help="Comma-separated sections to include: core,career,love,soul,timing,qa (default: all)")
    ...
    # v3.4: 合并扫描 root + parts/，避免 parts/ 存在时根目录主报告被忽略
    found = scan_root_and_parts(folder)

    if not found:
        print(f"\nError: No MD files found in {folder} or {folder}/parts/")
        print("  Expected files like: p2a_planets.md, career_phase12.md, love_step1.md, s1_atmakaraka.md, qa_*.md")
        sys.exit(1)

    # v3.4: 自动检测 structured_data.md 的 analysis_mode，CLI --mode 用于覆盖
    detected_mode = detect_analysis_mode(folder)
    cli_passed_mode = "--mode" in sys.argv
    if cli_passed_mode:
        # 用户显式传了 --mode，以命令行为准
        if detected_mode and detected_mode != args.mode:
            print(f"  ⚠️ structured_data.md detected analysis_mode = '{detected_mode}', "
                  f"but CLI --mode = '{args.mode}' overrides.")
        effective_mode = args.mode
    elif detected_mode:
        # 没传 --mode，但 structured_data.md 有显式值 → 用检测到的
        print(f"  Detected analysis_mode = '{detected_mode}' from structured_data.md")
        effective_mode = detected_mode
    else:
        # 都没有 → 用 default (blind)
        effective_mode = args.mode  # default = blind
    args.mode = effective_mode

    # --include 过滤：只保留指定部分
    if args.include:
        include_set = set(args.include.lower().split(","))
        # 定义 section key → group 映射（v3.2 同步所有新 skill key）
        group_map = {
            "core": {"core", "planets", "planets_a", "planets_b", "planets_c",
                     "divisional", "houses", "life", "life2", "appendix"},
            "career": {"career", "career1", "career2",
                       "career3a", "career3b", "career3c",
                       "career_arch", "career_chg"},
            "love": {"love", "love1", "love2", "love3", "love_t"},
            "soul": {"soul1", "soul2", "soul3", "soul4", "soul5", "soul6"},
            "timing": {"timing_g", "timing_d", "timing_y"},
            "qa": {"qa"},
        }
        allowed_keys = set()
    ...
    # Build HTML
    systems = detect_systems(found, lang)
    cover = build_cover(args.name, args.lagna, args.gender, args.status, pkg, desc, systems, lang)
    ...
    if args.mode == "calibrated":
        mode_note_cn = ('<br><span style="color:var(--gold)">⚠️ 校准模式 (calibrated)：'
                        '本报告读取了 reader 阶段的信号修正日志并据此调整解读，'
                        '不是纯盲审。</span>')
        mode_note_en = ('<br><span style="color:var(--gold)">⚠️ Calibrated mode: '
                        'this report incorporated the reader signal-correction log; '
                        'it is not a pure blind audit.</span>')
    else:
        mode_note_cn = '<br><span style="color:var(--text-muted)">盲审模式 (blind)：本报告未读取信号修正日志。</span>'
        mode_note_en = '<br><span style="color:var(--text-muted)">Blind mode: this report did not read the signal-correction log.</span>'

    footer_cn = f"""<div class="footer-note">
  本报告基于结构化星盘数据、传统吠陀占星规则（Parashari Jyotish | KN Rao School）和交叉验证流程生成。<br>
  结论供自我反思与战略思考参考，不构成确定性预测。{mode_note_cn}<br>
  &copy; Data-Driven Vedic Astrology</div>"""
    footer_en = f"""<div class="footer-note">
  This report is generated from structured chart data, traditional rules (Parashari Jyotish | KN Rao School), and cross-validation logic.<br>
  It is intended for self-reflection and strategic thinking, not deterministic prediction.{mode_note_en}<br>
  &copy; Data-Driven Vedic Astrology</div>"""
